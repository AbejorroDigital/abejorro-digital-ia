/**
 * Añade un mensaje al contenedor del chat con scroll robusto y seguridad íntegra.
 * @param {string} role - 'user' o 'ai'.
 * @param {string} content - Contenido HTML o texto del mensaje.
 * @returns {HTMLElement} El elemento donde se insertó el contenido.
 */
export function appendMessage(role, content) {
    ...
    if (role === 'ai') {
        ...
        // Mantenemos tu escape original para contenido de usuario
    ...
    // RESTAURACIÓN DE LA LÓGICA DE SEGURIDAD (Tu código original)
    ...
    // SCROLL MEJORADO SIN INTERRUMPIR LA LÓGICA
